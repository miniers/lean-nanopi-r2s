...
svn co https://github.com/songchenwen/nanopi-r2s/trunk/luci-app-r2sflasher lean/luci-app-r2sflasher

#npc
svn co https://github.com/coolsnowwolf/lede/trunk/package/lean/npc lean/npc
git clone https://github.com/lloyd18/luci-app-npc.git lean/luci-app-npc
#mosdns
git clone https://github.com/miniers/openwrt-mosdns.git lean/mosdns
